...
#'
#' @param .df A tibble generated by `wanted_pkg()`
#' 
#' @param do_install a boolean enabling the installation (defaults to `isTRUE(Sys.getenv("BS2_DEPLOY") == "1")`)
#'
#' @return The `.df` tibble with an updated `is_installed` column to confirm the success of all installations.
#'
#' @export
install_missing <- function(.df, do_install = isTRUE(Sys.getenv("BS2_DEPLOY") == "1")) {
